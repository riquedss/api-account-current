...
class CheckingAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checking_account" do
    assert_difference("CheckingAccount.count") do
      post checking_accounts_url, params: { checking_account: { account: @checking_account.account, balance: @checking_account.balance, password_digest: @checking_account.password_digest, status: @checking_account.status } }, as: :json
    end
  ...
  test "should update checking_account" do
    patch checking_account_url(@checking_account), params: { checking_account: { account: @checking_account.account, balance: @checking_account.balance, password_digest: @checking_account.password_digest, status: @checking_account.status } }, as: :json
    assert_response :success
  end
