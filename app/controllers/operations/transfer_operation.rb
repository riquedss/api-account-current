module Operations
  class TransferOperation
    ...
    def self.update_sender_balance(transfer)
      ...
      if @user.vip?
        update_balance({ balance: @checking_account.balance - transfer.balance - (transfer.balance * 0.008) })
      else
        update_balance({ balance: @checking_account.balance - transfer.balance - 8 })
      end
    end
